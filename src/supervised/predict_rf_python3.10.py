...
if __name__ == "__main__":
    raw_data_folder = "/content/IoT-AnomalyDetection/data_2/supervised/test_data"
    model_path = '/content/IoT-AnomalyDetection/models_2/supervised/rf_model.joblib'
    output_base_folder = "/content/IoT-AnomalyDetection/results"
